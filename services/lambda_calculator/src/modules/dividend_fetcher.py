...
def dividend_fetcher(df_investment_info: pl.DataFrame, conn: psycopg2._psycopg.connection) -> pl.DataFrame:
    try:
        ...
        # DB接続
        df_dividend = pl.read_database(query=select_query, connection=conn)
